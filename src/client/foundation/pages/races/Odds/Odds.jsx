    ...
    <Container>
      ...
      <Section>
        ...
        <Callout $closed={isRaceClosed}>
          <svg aria-hidden="true" className="svg-inline--fa fa-info-circle fa-w-16" data-fa-i2svg="" data-icon="info-circle" data-prefix="fas" focusable="false" role="img" style={{height: '1em', verticalAlign:'-0.125em', width: '1.125em'}} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
